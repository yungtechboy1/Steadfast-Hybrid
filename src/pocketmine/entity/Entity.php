...
use pocketmine\network\protocol\OldRemoveEntityPacket;
use pocketmine\network\protocol\OldSetEntityDataPacket;
...
abstract class Entity extends Location implements Metadatable{
	...
	public function sendMetadata($player){
		...
		foreach($player as $p){
			if($p === $this){
				/** @var Player $p */
				$pk2 = new OldSetEntityDataPacket();
				$pk2->eid = 0;
